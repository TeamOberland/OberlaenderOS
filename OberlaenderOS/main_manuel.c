...
//    timer_add_listener(_timer_userled0, 2500);
//    timer_add_listener(_timer_userled1, 5000);
//
//    __enable_interrupts();
//}
//
...
//    int i;
//    printf("Setup IRQ\n");
//    irq_add_listener(GPTIMER3_IRQ, _timer_userled0);
//
//    printf("Setup GPIOs\n");
//    gpio_direction_output(GPIO_USERLED0);
//
